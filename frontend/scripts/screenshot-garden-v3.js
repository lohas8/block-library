...
(async () => {
  ...
  console.log('1. 访问登录页...');
  await page.goto('http://localhost:3001/mobile/login', { waitUntil: 'networkidle', timeout: 15000 });
  ...
  await page.goto('http://localhost:3001/mobile/garden', { waitUntil: 'networkidle', timeout: 15000 });
